...
class Prince {
  constructor(name, age, sizeFoot) {
   ...
   findCenderella(array){
    let filter = array.find(Cinderella => Cinderella.heelSize === this.sizeFoot);
     find
     ?console.log('My Cinderella ' + filter.name)
     :console.log('I did not fond my Cinderella');
 }
}
 let man = new Prince('Yura', 28, 36);
 man.findCenderella(arrCinderella);
